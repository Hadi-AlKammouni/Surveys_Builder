...
const displayRadio = (detail) => {
    ...
    if(detail.option1 === null){
        ...
        return <div>
        <input type={detail.question_type} id={detail.option1} value={detail.option1}/>
        ...
        <input type={detail.question_type} id={detail.option1} value={detail.option1}/>
        <label for={detail.option1}>{detail.option1}</label><br></br>
        <input type={detail.question_type} id={detail.option2} value={detail.option2}/>
    ...
    return <div>
        ...
        <input type={detail.question_type} id={detail.option2} value={detail.option2}/>
        <label for={detail.option2}>{detail.option2}</label><br></br>
        <input type={detail.question_type} id={detail.option3} value={detail.option3}/>
